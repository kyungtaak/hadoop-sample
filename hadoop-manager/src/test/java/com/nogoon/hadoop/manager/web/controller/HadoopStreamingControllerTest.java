...
public class HadoopStreamingControllerTest {
	...
	public void viewManagerHome() throws Exception {
		...
		MvcResult result = mvc.perform(get("/streaming/script")
											.param("mapperScript", "abc")
											.param("reducerScript", "cdf")
											.param("inputPath", "abc")
											.param("outputPath", "abc"))
